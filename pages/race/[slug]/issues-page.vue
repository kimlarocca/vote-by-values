...
<template>
  <div class="home container p-4">
    <Html lang="en">
      <Head>
        <Title>
          VoteByValues.com | {{ race?.name || "Race" }} | Issues-Like Page Comparison
        </Title>
      </Head>
    </Html>
    ...
    <section v-if="loading" class="text-center bg-white rounded-xl p-8">
      ...
      <p>Loading issues-like page comparison...</p>
    </section>
